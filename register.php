...
."VALUES('".$user_id."','".$email."','".$ip."',NOW(),'".$password."',NOW(),'".$nick."','".$school."','".$confirmquestion."','".$confirmanswer."')";
...
//$database->insert("loginlog",["user_id"=>$user_id,"password"=>$password],"ip"=>)
...
$_SESSION['user_id']=$user_id;
		...
		//echo $sql."<br />";
		$result = $database->select("privilege","*",["user_id"=>$_SESSION["user_id"]]);
		//$result=mysqli_query($mysqli,$sql);
